...
use crate::mp4box::edts::EdtsBox;
use crate::mp4box::elst::{ElstBox, ElstEntry};
...
impl From<OpusConfig> for TrackConfig {
    fn from(opus_conf: OpusConfig) -> Self {
        Self {
            track_type: TrackType::Audio,
            // Opus runs at 48 kHz; use it as the media timescale so sample durations are
            // expressed directly in 48 kHz samples.
            timescale: 48000,
